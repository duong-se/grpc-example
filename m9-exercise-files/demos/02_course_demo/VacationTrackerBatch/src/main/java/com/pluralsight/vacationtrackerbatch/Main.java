...
import com.pluralsight.vacationtrackerbatch.dataaccess.EmployeeDaoGrpc;
...
public class Main {
    ...
    private static EmployeeDao employeeDao = new EmployeeDaoGrpc();
    ...
    public static void main(String args[]) {
        ...
        for (Employee emp : employees) {
            double newVacationAccrued = emp.getVacationAccrued() + emp.getVacationAccuralRate();
